...
graph_word_extractor::graph_word_extractor()
{
...
var_4 graph_word_extractor::init(
    var_1* _cfg_path,
...
//RET   0：正常 其他：错误码 可用get_error_description获取错误信息
var_4 graph_word_extractor::extract(
    var_u4 _doc_len, 
    var_1* _doc_pointer)
{
...
//RET   0：正常 其他：错误码 可用get_error_description获取错误信息
var_4 graph_word_extractor::get_term(
    word_type_e _type, 
...
//IN    _calc_type: 待获取的词语类型
//RET   0：正常 其他：错误码 可用get_error_description获取错误信息
var_4 graph_word_extractor::get_count(
    word_type_e _type)
{
    return 0;
}
...
var_1* graph_word_extractor::get_error_description(
    var_4 _err_code)
{
    return 0;
}

var_vd graph_word_extractor::uninit()
{
